...
namespace CustomBoard
{
    ...
    public partial class CustomBoard : UserControl
    {
        ...
        public ColorButton.customButton GreenButton
        {
        ...
        EditorBrowsable(EditorBrowsableState.Always),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public ColorButton.customButton RedButton
        {
        ...
        EditorBrowsable(EditorBrowsableState.Always),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public ColorButton.customButton YellowButton
        {
        ...
        EditorBrowsable(EditorBrowsableState.Always),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public ColorButton.customButton BlueButton
        {
        ...
        private void CustomButton_Click(object sender, EventArgs e)
        {
            ...
            OnButtonClick(new ButtonClickEventArgs(((ColorButton.customButton)sender).ColorValue));
