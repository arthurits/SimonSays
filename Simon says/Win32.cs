...
public class Win32API
{
	...
	[DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
	private static extern int QueryFullProcessImageName(IntPtr hProcess, int dwFlags, System.Text.StringBuilder lpExeName, int lpdwSize);
	...
	[DllImport("user32.dll", CharSet = CharSet.Unicode)]
	private static extern int GetWindowModuleFileName(IntPtr hWnd, System.Text.StringBuilder lpString, int nMaxCount);
	...
	{
		System.Text.StringBuilder pszOut = new((int)Win32API.MAX_PATH);
		System.Text.StringBuilder pszSrc = new(source);
	...
	[DllImport("psapi.dll", CharSet = CharSet.Unicode)]
	private static extern int GetModuleBaseName(IntPtr hProcess, IntPtr hModule, System.Text.StringBuilder lpFilename, int nSize);
