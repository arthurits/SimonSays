...
public class WaveGenerator
{
    ...
    readonly WaveFormatChunk format;
    readonly WaveDataChunk data;
    readonly System.IO.MemoryStream audioStream;
    ...
    public void GenerateAudioStream()
    {
        ...
        System.IO.BinaryWriter writer = new(audioStream);
    ...
    public void Save(string filePath)
    {
        ...
        System.IO.FileStream fileStream = new(filePath, System.IO.FileMode.Create);

        // Use BinaryWriter to write the bytes to the file
        System.IO.BinaryWriter writer = new(fileStream);
    ...
    {
        System.IO.MemoryStream mStrm = new();
        System.IO.BinaryWriter writer = new(mStrm);
